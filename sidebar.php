...
<div class="page-sidebar">
    <ul class="x-navigation">
       ...
       <li <?= $s0?$s0:''; ?>><a href="companies.php"><span class="fa fa-bank"></span> <span class="xn-text">Companies</span></a> </li>
        <li <?= $s1?$s1:''; ?>><a href="projects.php"><span class="fa fa-inbox"></span> <span class="xn-text">projects</span></a> </li>
         <li <?= $s2?$s2:''; ?>><a href="#"><span class="fa fa-tasks"></span> <span class="xn-text">tasks</span></a> </li>
